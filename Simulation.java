...
public class Simulation{
    ...
    public void initiate() {
        ...
        // calling method to add algaes on panel
        addAlgae();
        
        // adding buttons to switch day/night
        day = new JButton(new ImageIcon("daylight.png"));
        day.setBounds(280, 780, 50, 50);
        day.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e)
            {
                // change mode to day on button press
                if(mode == 0)
                {
                    mode = 1;
                    if(started)
        ...
        night = new JButton(new ImageIcon("Nightmood.png"));
        night.setBounds(350, 780, 50, 50);
        night.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e)
            {
                // change mode to night on button press
                if(mode == 1)
                {
                    mode = 0;
                    whaleTimer.stop();
        ...
        whaleTimer = new Timer(10, new ActionListener(){
           public void actionPerformed(ActionEvent e)
           {
               // if a whale completes its life of 55 rounds then remove it
               ...
               // to search for goldfish as food and eat it
               for(int i=0;i<whales.size();i++)
               {
                   ...
                   // to search for jellyfish as food and eat it
               ...
               // reproduce whale if two wales interact while respecting birth delay
               for(int i=0;i<whales.size();i++)
               {
        ...
        JellyfishesTimer = new Timer(10, new ActionListener(){
           public void actionPerformed(ActionEvent e)
           {
               ...
               // Add a new jellyfish if one dies
               for(int j=0;j<jellyfishes.size();j++)
                {
                               ...
                               if(mode == 1)
                                {
                                    ...
                                    round++;
                                    speciesPanel.repaint();
                                    // decrease stiety and incrase age
                                    for(int i=0;i<whales.size();i++)
                                    {
